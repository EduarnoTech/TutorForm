...
class CustomNavbar extends Component {
    //  [signedUp,signedUpHandler]=useState()

  
   
    render() {
        var {mClass, nClass, cClass, slogo, hbtnClass,isSignUp} =this.props;
        return (
                    ...
                    <div className={`container ${cClass}`}>
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className={`navbar-nav menu ml-auto ${nClass}`}>
                                ...
                                <li className="dropdown submenu nav-item"><Link title="Pages" className="dropdown-toggle nav-link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" to="#">Pricing</Link>
                                    {/* <ul role="menu" className=" dropdown-menu">
                                ...
                                <li className="nav-item"><NavLink title="Pricing" className="nav-link" to="/Contact">Reviews</NavLink></li>
                                <li className="nav-item"><NavLink title="Pricing" className="nav-link" to="/Contact">FAQs</NavLink></li>
                                <li className="nav-item"><NavLink title="Pricing" className="nav-link" to="/TutorSignUp">Become A Tutor</NavLink></li>
                                <li className="nav-item"><NavLink title="Dashboard" className="nav-link"  to= "/" >Dashboard</NavLink></li>
                                
                            </ul>
                          
                            {isSignUp && <a className={`btn_get btn_hover ${hbtnClass}`} href="/signUp">Sign Up</a>}
                            {!isSignUp && <a className={`btn_get btn_hover ${hbtnClass}`} href="/SignIn" >Sign In</a>}
                        </div>
                    </div>
                </nav>
                </header>
